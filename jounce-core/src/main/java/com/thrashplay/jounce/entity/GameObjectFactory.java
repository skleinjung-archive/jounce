...
//            angle = Random.getInteger(2) == 0 ? 45 : 315;
        ...
        ball.addComponent(new CollisionConfig(CollisionCategory.BALL, new Rectangle(0, 0, diameter, diameter)));
    ...
    public GameObject createTopWall() {
        ...
        topWall.addComponent(new CollisionConfig(CollisionCategory.TOP_WALL, new Rectangle(0, 0, gameBounds.getWidth(), 5)));
        return topWall;
    }
    ...
    public GameObject createBottomWall() {
        ...
        bottomWall.addComponent(new CollisionConfig(CollisionCategory.BOTTOM_WALL, new Rectangle(0, 0, gameBounds.getWidth(), 5)));
        return bottomWall;
    }
    ...
    private GameObject createPaddle(String id, int collisionCategory, int positionX, UpdateableComponent controller) {
        ...
        paddle.addComponent(new CollisionConfig(collisionCategory, new Rectangle(0, 0, 15, paddleHeight)));
